...
<?php
   ...
   if(isset($_GET['submit'])){
	...
	$sql = "Select DISTINCT id_producator, nume
FROM Film INNER JOIN Persoana ON Film.id_producator = Persoana.id_persoana
WHERE EXISTS (SELECT id_actor From Distributie WHERE Distributie.id_actor = Film.id_producator and distributie.titlu_film = film.titlu);";
