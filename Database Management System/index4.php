...
<?php
   ...
   if(isset($_GET['submit'])){
	...
	$sql = "SELECT d1.id_actor, d2.id_actor
FROM DISTRIBUTIE d1, DISTRIBUTIE d2
WHERE d1.id_actor <> d2.id_actor and d1.titlu_film = d2.titlu_film and d1.id_actor > d2.id_actor and (SELECT sex FROM Persoana Where id_persoana = d1.id_actor) <> (SELECT sex From Persoana where id_persoana = d2.id_actor);";
