 ...
 <div>
  ...
  <article>
   <form>
	...
	<input type = "text" name = "an" placeholder="Introduceti An">
	<input type = "text" name = "gen" placeholder="Introduceti Genul">
	<br>
...
<?php
   ...
   if(isset($_GET['submit'])){
    $an= $_GET['an'];
	$gen = $_GET['gen'];
	$sql = "SELECT * FROM Film WHERE an > $an and gen = '$gen' ORDER BY an, titlu;";
