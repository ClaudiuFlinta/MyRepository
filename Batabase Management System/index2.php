 ...
 <div>
  ...
  <article>
   <form>
	...
	<input type = "text" name = "sex" placeholder="Introduceti Sex">
	<input type = "text" name = "castig" placeholder="Introduceti Catig Net">
	<input type = "text" name = "moneda" placeholder="Introduceti Moneda">
	<br>
...
<?php
   ...
   if(isset($_GET['submit'])){
	...
	$castig = $_GET['castig'];
	$moneda = $_GET['moneda'];
	$sql = "SELECT nume FROM Persoana WHERE sex = '$sex' and castig_net > $castig and moneda = '$moneda' ORDER BY nume ASC;";
